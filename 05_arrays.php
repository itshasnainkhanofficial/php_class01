...
// // if Person not have address then set it to unknown 
// if (!isset($person['address'])){
//     $person['address'] = 'Unknown';
// }
// $person['address'] ??= 'Unknown'; // sorthand

// $person['address'] = $person['address'] ?? 'Unknown'; // sorthand
